...
NOTE: There is no need to import any other package as all the dependancies of this package are included. All models are from 3dwarehouse.sketchup.com and can be used 
      commercially.
...
1. Cubemap reflections:
   ...
   b. Modify the settings in the Realtime Reflections Script under the Reflection Manager.
